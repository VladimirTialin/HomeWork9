namespace MyFirstWebApplication.Models
{
    ...
    public class WeatherForecastHolder
    {
        ...
        {
            _values.RemoveAll(item => item.Date == date);

            return true;
        }
        public bool Remove(DateTime date, int temperatureC)
        {
            _values.RemoveAll(item => item.Date == date && item.TemperatureC==temperatureC);
